...
import com.android.support.animation.Titanic;
import com.android.support.animation.TitanicTextView;
...
public class Menu {
  ...
  int BTN_COLOR = Color.parseColor("#8C104CE3");
  int MENU_BG_COLOR = Color.parseColor("#8CEFCC5B"); // #AARRGGBB
  int MENU_FEATURE_BG_COLOR = Color.parseColor("#00EFCC5B"); //
  int MENU_WIDTH = 220;
  int MENU_HEIGHT = 350;
  int POS_X = 0;
  int POS_Y = 100;
  ...
  int BtnON = Color.parseColor("#8C95f542"); // Semi Green
  int BtnOFF = Color.parseColor("#8CFF0000"); // Semi Red
  int CategoryBG = Color.parseColor("#8C104CE3");
  int SeekBarColor = Color.parseColor("#E60000FF");
  int SeekBarProgressColor = Color.parseColor("#0000FF");
  ...
  public Menu(Context context) {
    ...
    // gdMenuBody.setStroke(2, Color.parseColor("#FF0000")); //Set border
    mExpanded.setBackground(gdMenuBody); // Apply GradientDrawable to it

    try {
      InputStream ims = context.getAssets().open("stardust.png");
    ...
    settings.setText(Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M ? "ϟ" : "\u03DF");
    ...
    TitanicTextView title = new TitanicTextView(context);
    // title.setText(Html.fromHtml(Title()));
    title.setTextColor(TEXT_COLOR);
    title.setTextSize(20.0f);
    title.setGravity(Gravity.CENTER);
    title.setTypeface(Typeface.createFromAsset(context.getAssets(), "kvjvkgifiduxufuxud.ttf"), 0);
    title.setGravity(Gravity.CENTER);
    ...
    int[] colorsCRNTC = {Color.parseColor("#8C104CE3"), Color.parseColor("#8C104CE3")};
    android.graphics.drawable.GradientDrawable CRNTC =
        new android.graphics.drawable.GradientDrawable(
            android.graphics.drawable.GradientDrawable.Orientation.TOP_BOTTOM, colorsCRNTC);
    CRNTC.setCornerRadii(new float[] {0, 0, 60, 60, 0, 0, 0, 0});
    CRNTC.setStroke(1, Color.parseColor("#0000FF"));
    hideBtn.setElevation((float) 0);
    hideBtn.setBackground(CRNTC);
    ...
    int[] colorsCRNOP = {Color.parseColor("#8C104CE3"), Color.parseColor("#8C104CE3")};
    android.graphics.drawable.GradientDrawable CRNOP =
        new android.graphics.drawable.GradientDrawable(
            android.graphics.drawable.GradientDrawable.Orientation.TOP_BOTTOM, colorsCRNOP);
    CRNOP.setCornerRadii(new float[] {60, 60, 0, 0, 0, 0, 0, 0});
    CRNOP.setStroke(1, Color.parseColor("#0000FF"));
    closeBtn.setElevation((float) 0);
    closeBtn.setBackground(CRNOP);
  ...
  int LST_MAB = Color.parseColor("#ffffff");
  ...
  private void Switch(
    ...
    if (isOn) {
      GD_TRACK.setStroke(1, Color.WHITE);
      GD_TRACK.setColor(LST_MAB);

      GD_THUMB.setStroke(1, Color.WHITE);
      GD_THUMB.setColor(Color.BLUE);
    } else {
      GD_TRACK.setStroke(1, Color.BLUE);
      GD_TRACK.setColor(Color.argb(200, 255, 255, 255));

      GD_THUMB.setStroke(1, Color.BLUE);
            ...
            switch (featNum) {
              ...
              case -6:
                if (bool) {
                  ...
                  // mExpanded.setBackground(blackgamer);
              ...
              case -7:
                if (bool) {
                  ...
                  gdMenuBody.setColor(Color.parseColor("#8C000000")); // Set background color
                  gdMenuBody.setStroke(1, Color.WHITE); // Set border
                  mExpanded.setBackground(gdMenuBody); // Apply GradientDrawable to it
  ...
  private void SeekBar(
    ...
    GD_THUMB.setStroke(dp(2), SeekBarProgressColor);
    GD_THUMB.setOrientation(GradientDrawable.Orientation.RIGHT_LEFT);
    GD_THUMB.setCornerRadii(new float[] {25, 25, 25, 25, 25, 25, 25, 25});
    GD_THUMB.setSize(40, 40);
  ...
  private void Button(LinearLayout linLayout, final int featNum, final String featName) {
    ...
    int[] colorsCRNTE = {Color.parseColor("#8C0000FF"), Color.parseColor("#8C0088FF")};
    android.graphics.drawable.GradientDrawable CRNTE =
        new android.graphics.drawable.GradientDrawable(
            android.graphics.drawable.GradientDrawable.Orientation.TL_BR, colorsCRNTE);
    CRNTE.setCornerRadii(new float[] {25, 25, 25, 25, 25, 25, 25, 25});
    CRNTE.setStroke(0, Color.parseColor("#000000"));
    button.setElevation((float) 0);
    button.setBackground(CRNTE);
  ...
  private void ButtonOnOff(
    ...
    GradientDrawable lx = new GradientDrawable();
    lx.setCornerRadii(new float[] {25, 25, 25, 25, 25, 25, 25, 25});
    //   button.setBackground(lx);
    ...
    if (isOn) {
      ...
      int[] colorsCRNSZ = {Color.parseColor("#8C0000FF"), Color.parseColor("#8C0088FF")};
      android.graphics.drawable.GradientDrawable CRNSZ =
          new android.graphics.drawable.GradientDrawable(
              android.graphics.drawable.GradientDrawable.Orientation.TL_BR, colorsCRNSZ);
      CRNSZ.setCornerRadii(new float[] {25, 25, 25, 25, 25, 25, 25, 25});
      CRNSZ.setStroke(0, Color.parseColor("#000000"));
      button.setElevation((float) 0);
      button.setBackground(CRNSZ);
      isOn = false;
    } else {
      button.setText(Html.fromHtml(finalfeatName + ": OFF"));
      button.setBackgroundColor(BtnOFF);
      int[] colorsCRNAR = {Color.parseColor("#8CFF0000"), Color.parseColor("#8CFFAE00")};
      android.graphics.drawable.GradientDrawable CRNAR =
          new android.graphics.drawable.GradientDrawable(
              android.graphics.drawable.GradientDrawable.Orientation.TL_BR, colorsCRNAR);
      CRNAR.setCornerRadii(new float[] {25, 25, 25, 25, 25, 25, 25, 25});
      CRNAR.setStroke(0, Color.parseColor("#000000"));
      button.setElevation((float) 0);
      button.setBackground(CRNAR);
      isOn = true;
    }
  ...
  private void Category(LinearLayout linLayout, String text) {
    ...
    int[] colorsCRNRF = {Color.parseColor("#8C0000FF"), Color.parseColor("#8C0088FF")};
    android.graphics.drawable.GradientDrawable CRNRF =
        new android.graphics.drawable.GradientDrawable(
            android.graphics.drawable.GradientDrawable.Orientation.TL_BR, colorsCRNRF);
    CRNRF.setCornerRadii(new float[] {0, 0, 0, 0, 0, 0, 0, 0});
    CRNRF.setStroke(0, Color.parseColor("#000000"));
    textView.setElevation((float) 0);
    textView.setBackground(CRNRF);
